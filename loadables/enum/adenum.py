...
class LdapEnum:
    ...
    def GetDomainAdminGroup(self)->None:
        printTitle("[-] Users who are Domain Admin Group")

        OBJECT_TO_SEARCH = '(&(objectclass=User)(memberof=CN=domain admins,CN=Users,DC=Medtech,DC=com))'
